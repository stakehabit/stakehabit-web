      ...
      >
                ...
                {[5, 10, 15, 20].map((p) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: "8px",
                      border: `1px solid ${
                        maxParticipants === p ? "var(--gold)" : "var(--rule)"
                      }`,
                      background:
                        maxParticipants === p
                          ? "color-mix(in srgb, var(--gold) 12%, var(--surface))"
        ...
        {step === "stake" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            >
              Each participant will stake this amount. Total pot = {amount} ×{" "}
              {maxParticipants} = {(amount * maxParticipants).toLocaleString()}{" "}
              {currency}
            </p>
          </div>
        )}
        ...
        {step === "rules" && (
          ...
          >
            ...
            <div>
                ...
                {[50, 60, 70, 80].map((split) => (
                  <button
                    ...
                    style={{
                      ...
                      borderRadius: "8px",
                      border: `1px solid ${
                        winnerSplit === split ? "var(--gold)" : "var(--rule)"
                      }`,
                      background:
                        winnerSplit === split
                          ? "color-mix(in srgb, var(--gold) 12%, var(--surface))"
              ...
              >
                Winners split {winnerSplit}% of forfeited stakes. Remaining{" "}
                {100 - winnerSplit}% goes to charity.
              </p>
            </div>
        ...
        {step === "confirm" && (
          ...
          >
            ...
            {[
              ...
              {
                label: "Total pot potential",
                value: `${(amount * maxParticipants).toLocaleString()} ${currency}`,
              },
              ...
              >
                ...
                <span
                  style={{
                    fontFamily:
                      row.label.includes("Stake") || row.label.includes("pot")
                        ? "var(--font-mono)"
                        : "var(--font-sans)",
                    fontSize: "14px",
                    color:
            ...
            >
              By creating this pool, you authorize the Soroban contract to lock{" "}
              <strong style={{ color: "var(--text)" }}>
                {amount.toLocaleString()} {currency}
              </strong>{" "}
              from your wallet as the first stake. Other participants can join
